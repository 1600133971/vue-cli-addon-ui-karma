  ...
  <div class="build-status">
    <div class="content">
      <div class="info-block status">
        <div class="label">
          {{ $t('org.vue.st.karma.build-status.labels.status') }}
        </div>
        <div class="value">{{ $t(`org.vue.st.karma.build-status.${status || 'Idle'}`) }}</div>
      </div>
    </div>
    <div class="content">
      <div class="info-block total">
        <div class="label">
          {{ $t('org.vue.st.karma.build-status.labels.total') }}
        </div>
        <div class="value">{{ total }}</div>
      </div>
      <div class="info-block skipped">
        <div class="label">
          {{ $t('org.vue.st.karma.build-status.labels.skipped') }}
        </div>
        <div class="value">{{ skipped }}</div>
      </div>
      <div class="info-block processed">
        <div class="label">
          {{ $t('org.vue.st.karma.build-status.labels.processed') }}
        </div>
        <div class="value">{{ processed }}</div>
      </div>
      <div class="info-block passed">
        <div class="label">
          {{ $t('org.vue.st.karma.build-status.labels.passed') }}
        </div>
        <div class="value">{{ passed }}</div>
      </div>
      <div class="info-block failed">
        <div class="label">
          {{ $t('org.vue.st.karma.build-status.labels.failed') }}
        </div>
        <div class="value">{{ failed }}</div>
      </div>
      <div class="info-block duration">
        <div class="label">
          {{ $t('org.vue.st.karma.build-status.labels.duration') }}
        </div>
        <div class="value">{{ duration }}</div>
      </div>
      <div class="info-block startTime">
        <div class="label">
          {{ $t('org.vue.st.karma.build-status.labels.startTime') }}
        </div>
        <div class="value">{{ startTime }}</div>
      </div>
      <div class="info-block endTime">
        <div class="label">
          {{ $t('org.vue.st.karma.build-status.labels.endTime') }}
        </div>
        <div class="value">{{ endTime }}</div>
      </div>
      <div class="info-block userAgents">
        <div class="label">
          {{ $t('org.vue.st.karma.build-status.labels.userAgents') }}
        </div>
